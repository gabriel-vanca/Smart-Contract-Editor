...
public class LatestTime extends TimeOperator {

    public final static String MainLabel = "LST";
    public final static String[] Labels = {"LST", "LATEST"};
    ...
    public LatestTime(String[] inputParameters, Contract currentContract) {
