...
public abstract class TimeSpanOperator {
    ...
    public TimeSpanOperator(GetDiscreteTime initialDate, GetDiscreteTime finalDate) {
        this.initialDate = initialDate;
        this.finalDate = finalDate;
    }

    public TimeSpanOperator(String[] parameters, Contract currentContract) {
